...
/**
 * Instances of this interface act as keys which allow data of any type to be stored in {@link RPGData} at
 ...
 * as a spell class. They can then be used as keys to access the values themselves via {@link RPGData}.
